...
# migrations folder is created after init

# __tablename__ referering to table "user" has some different fields created manually , and if you are overriding them by class, it gets overridden
